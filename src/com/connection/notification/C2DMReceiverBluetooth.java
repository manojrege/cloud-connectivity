...
public class C2DMReceiverBluetooth extends C2DMBaseReceiver {
	...
	public C2DMReceiverBluetooth(Context c) {
	...
	protected void onMessage(Context context, Intent intent) {
		...
		if (extras != null) {
			...
			try {
				...
				Gson gson=new Gson();
				payload=new BluetoothPayload();
				payload=gson.fromJson(obj.toString(),BluetoothPayload.class);
			...
			/*	this.cfg.SSID="\"".concat(payload.ssid).concat("\"");
				...
				System.out.println(Integer.toString(rssi));
				}*/
